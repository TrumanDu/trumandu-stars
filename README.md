...
- [beehive-lab/jllm](https://github.com/beehive-lab/jllm) - AI inference engine for Java in Java. Fast.
...
- [wgzhao/Addax](https://github.com/wgzhao/Addax) - Actively maintained fork of Alibaba DataX — a fast, versatile ETL tool for RDBMS/NoSQL data transfer
...
- [ByteVisionLab/DreamLite](https://github.com/ByteVisionLab/DreamLite) - [ECCV 2026] 🔥 Official impl. of "DreamLite: A Lightweight On-Device Unified Model for Image Generation and Editing".
...
- [pbstar/fitview](https://github.com/pbstar/fitview) - 视口自适应 JS 插件，一行代码让固定尺寸的大屏设计稿自适应任意容器，支持 fill / contain / scroll / hidden 四种适配模式。
